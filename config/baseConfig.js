...
config.prototype.businessDB = {
    ...
    user: 'root',
    password: 'Pass@word1',
    database: 'digital_marketing_recruitment',//'digital_marketing_sit',
...
config.prototype.basicSettings = {
    ...
    innerVersion: "v2.0.2-2015724-5932-02",//舆情系统版本号
    autoVersion: "v2.0.2-2015724-5932-03",//舆情自助系统版本号
...
config.prototype.proxy = {
    ...
    crawEngine: {prefix: '/crawEngine/*',prefixHead:'crawEngine',host:'10.16.136.12',port:'8080', url: 'http://192.168.100.32:8080/', domain: ''},
    //segmentWorld: {prefix: '/services/*',host:'10.16.136.12',port:'8899', url: 'http://10.16.136.12:8899', domain: ''}//prod
    segmentWorld: {prefix: '/services/*',host:'192.168.100.183',port:'8899', url: 'http://192.168.100.183:9999', domain: '',tagBatchAdd:'/services/tag/batchAdd.json'},//dev
}

config.prototype.baseInfoSeting={
    //系统url
    systemUrl:'http://127.0.0.1:10001/',
    //文件库
    fileLib:{
        //网站地址
        ...
        uploadLogo:{
            ...
            delUrl:'/dimage/',
            //图片下载地址
            imageUrl:'http://127.0.0.1:10004/image'
        }

    },
    api:{
        //api服务地址
        url:'http://127.0.0.1:10003/services/'
    }
};
