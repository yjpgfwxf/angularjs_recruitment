...
config.prototype.basicSettings = {
    ...
    environment: "sentiment_prod", //"PROD" "SIT"，
    innerVersion: "v2.0.2-20150824-6826-02",//舆情系统版本号
    autoVersion: "v1.0.2-20150824-6889-03",//舆情自助系统版本号
...
config.prototype.proxy = {
    ...
    crawEngine: {prefix: '/crawEngine/*',prefixHead:'crawEngine',host:'10.16.136.12',port:'8080', url: 'http://10.16.136.12:8080/', domain: ''},
    segmentWorld: {prefix: '/services/*',host:'10.16.136.12',port:'8899', url: 'http://10.16.136.12:8899', domain: ''}
}

config.prototype.baseInfoSeting={
    //系统url
    systemUrl:'http://www.issyq.com/',
    //文件库
    fileLib:{
        //网站地址
        host:'http://223.223.181.117:10004',
        uploadLogo:{
            //logo上传地址
            ...
            delUrl:'/dimage/',
            //图片下载地址
            imageUrl:'http://223.223.181.117:10004/image/'
        }

    },
    api:{
        //api服务地址
        url:'http://223.223.181.117:10003/services/'
    }
};
